...
--
-- Name: access access_creatorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.access
    ADD CONSTRAINT "access_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES public.users(id);
